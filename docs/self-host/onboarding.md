...
| Item                                  | Notes                                                                                                                                                  |
| ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Their callback URL**                | Must be `https://`, must NOT be a private/internal IP. They build the receiver per the [Integration guide](/guide/integration#step-4-receive-webhooks) |
...
- They follow [Integration guide](/guide/integration) on their end
